...
```markdown
# AIPL - [Episode Number]: [Episode Title]
...
```markdown
# AIPL - Episode 42: Building a Referral Engine That Replaces Paid Ads
...
```markdown
# AIPL - Episode 58: 5 Systems Every Solopreneur Needs to Stop Working in Chaos
